...
class Plotter:
    ...
    def run(self, root_dir: Path):
        results_file = f"{root_dir}/results_svm.json"
        output_file = f"{root_dir}/plot_svm_{self.degree}_{self.C}.png"
...
if __name__ == "__main__":
    ...
    Plotter(sampling_rate=16000, degree=20, C=1.0).run(root_dir=curdir)

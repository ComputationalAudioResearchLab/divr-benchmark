...
if __name__ == "__main__":
    cluster = Cluster(
        ...
        output_folder=Path("/home/storage/data/nn_latents_full/16000/tsne"),
        diagnosis_level=0,
    )
    cluster.run(
        key="voiced",
        files=[
            ...
            Path("/home/storage/data/nn_latents_full/16000/features/voiced_test.json"),
        ],
    )
    cluster.run(
        key="svd_a",
        files=[
            ...
            Path("/home/storage/data/nn_latents_full/16000/features/svd_a_n_test.json"),
        ],
    )
    cluster.run(
        key="svd_i",
        files=[
            ...
            Path("/home/storage/data/nn_latents_full/16000/features/svd_i_n_test.json"),
        ],
    )
    cluster.run(
        key="svd_u",
    ...
    cluster.run(
        ...
        files=[
            ...
            Path("/home/storage/data/nn_latents_full/16000/features/svd_a_n_test.json"),
            Path("/home/storage/data/nn_latents_full/16000/features/svd_i_n_test.json"),
            Path("/home/storage/data/nn_latents_full/16000/features/svd_u_n_test.json"),
        ],
    )
